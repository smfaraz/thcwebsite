...
import { Linkedin, Twitter, Facebook, ChevronRight, Mail, Phone, MapPin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
             ...
             <p className="text-gray-400 text-sm max-w-sm mb-6">
               Talent Hunters Consulting. Challenge us to find your next international recruit.
             </p>
             <div className="flex space-x-4">
               <a href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-white transition-colors focus:outline-none focus:text-white"><Linkedin className="w-5 h-5" /></a>
               <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-white transition-colors focus:outline-none focus:text-white"><Twitter className="w-5 h-5" /></a>
               <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-white transition-colors focus:outline-none focus:text-white"><Facebook className="w-5 h-5" /></a>
             </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li className="flex gap-2 items-center">
                ...
                <span>+966 597 644 711 / +91 74101 97799</span>
              </li>
              <li className="flex gap-2 items-center">
                <Mail className="w-4 h-4 text-thc-orange" aria-hidden="true" />
                <a href="mailto:info@talenthuntersconsulting.com" className="hover:text-white focus:text-white focus:outline-none">info@talenthuntersconsulting.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="http://www.talenthuntersconsulting.com" className="hover:text-white focus:text-white focus:outline-none">www.talenthuntersconsulting.com</a>
          </div>
        </div>
      </div>
    </footer>
